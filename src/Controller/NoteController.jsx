...
var controller = {
  ...
  deletenote(id) {
    return axios.put(`http://localhost:8080/note/delete/${id}`, null, { headers: { jwt: token, "Content-type": "application/json " } })
  },

  restorenote(id) {
    return axios.put(`http://localhost:8080/note/restore/${token}`, null, { headers: { id: id, "Content-type": "application/json " } })
  },
  deletenoteforever(id) {
    return axios.put(`http://localhost:8080/note/deleteforever/${token}`, null, { headers: { id: id, "Content-type": "application/json " } })
  },
  emptytrash() {
    return axios.put(`http://localhost:8080/note/emptytrash/${token}`, null, { headers: { "Content-type": "application/json " } })
  }
